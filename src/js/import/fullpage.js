  ...
  $('#fullpage').fullpage({
    ...
    onLeave: function(index, nextIndex, direction) {
      if (nextIndex === 2) {
        ...
        $('.ibc__advantages__block--4 img').addClass('animated fadeIn').css('animation-delay', '1.8s');
        $('.ibc__advantages__block--4 p ').addClass('animated fadeInRight').css('animation-delay', '2s');
